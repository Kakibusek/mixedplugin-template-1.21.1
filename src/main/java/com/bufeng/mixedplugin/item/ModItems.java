...
import com.bufeng.mixedplugin.item.custom.Prospector;
...
public class ModItems {
    ...
    public static final Item DZQ_COAL = registerItem("dzq_coal", new Item(new Item.Settings()));
    public static final Item PROSPECTOR = registerItem("prospector", new Prospector(new Item.Settings().maxDamage(127)));
    public static final Item STARDUST_JELLY = registerItem("stardust_jelly", new Item(new Item.Settings().food(ModFoodComponents.STARDUST_JELLY)));
